...
import com.lianggao.whut.androidebook.View.FlipperLayout;
import com.lianggao.whut.androidebook.View.FlipperLayout.TouchListener;
import com.lianggao.whut.androidebook.View.ReadView;
...
public class MainActivity2 extends Activity implements OnClickListener, TouchListener {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_DRAW_TEXT:
                    ...
                    View recoverView = LayoutInflater.from(MainActivity2.this).inflate(R.layout.view_new, null);
                    View view1 = LayoutInflater.from(MainActivity2.this).inflate(R.layout.view_new, null);
                    View view2 = LayoutInflater.from(MainActivity2.this).inflate(R.layout.view_new, null);

                    rootLayout.initFlipperViews(MainActivity2.this, view2, view1, recoverView);
