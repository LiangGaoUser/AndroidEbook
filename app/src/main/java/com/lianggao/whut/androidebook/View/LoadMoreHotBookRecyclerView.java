...
public class LoadMoreHotBookRecyclerView extends RecyclerView {

    private LinearLayoutManager mLinearLayoutManager;
    private LoadMoreBookAdapter mAdapter;
    private GridLayoutManager gridLayoutManager;

    public LoadMoreHotBookRecyclerView(Context context) {
        this(context,null);
    }

    public LoadMoreHotBookRecyclerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public LoadMoreHotBookRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
