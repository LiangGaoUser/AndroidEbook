...
public class LoadMoreBookRecyclerView extends RecyclerView {

    private LinearLayoutManager mLinearLayoutManager;
    private LoadMoreBookAdapter mAdapter;
    private GridLayoutManager gridLayoutManager;

    public LoadMoreBookRecyclerView(Context context) {
        this(context,null);
    }

    public LoadMoreBookRecyclerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public LoadMoreBookRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
