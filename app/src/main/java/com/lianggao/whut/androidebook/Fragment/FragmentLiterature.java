...
public class FragmentLiterature extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       if(rootView==null){
           ...
           getBookShelfLiterature();
       }
        return rootView;
    }

    private void getBookShelfLiterature(){
        new Thread(){
            @Override
            public void run() {
                bookShelfTableManger=new bookShelfTableManger(getContext());
                bookShelfTableManger.createDb();
                bookList= bookShelfTableManger.findAllLiterure();
