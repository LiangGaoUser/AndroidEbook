...
/**
 * @author LiangGao
 * @description:展示书架历史的的适配器，对应地是part_activity_book_recycler.xml
 * @data:${DATA} 16:17
 */
public class BookShelfHistoryRecyclerViewAdapter extends RecyclerView.Adapter<BookShelfHistoryRecyclerViewAdapter.MyViewHolder> {
    ...
    public BookShelfHistoryRecyclerViewAdapter(Context context, List<String>book_post_path_list, List<String>book_name_list, List<String>book_author_list, List<String>book_kind_list, List<String>book_shortcontent_list){
